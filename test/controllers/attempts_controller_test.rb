...
class AttemptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post attempts_url, params: { attempt: { card_id: @attempt.card_id, check_id: @attempt.check_id, result: @attempt.result, user_id: @attempt.user_id } }
    end
  ...
  test "should update attempt" do
    patch attempt_url(@attempt), params: { attempt: { card_id: @attempt.card_id, check_id: @attempt.check_id, result: @attempt.result, user_id: @attempt.user_id } }
