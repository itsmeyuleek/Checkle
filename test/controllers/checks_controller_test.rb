...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post checks_url, params: { check: { failure: @check.failure, success: @check.success, user_id: @check.user_id } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { failure: @check.failure, success: @check.success, user_id: @check.user_id } }
